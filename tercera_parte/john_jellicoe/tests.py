...
class TestJohnJellicoe(unittest.TestCase):
    ...
    def test_JJ_3_3_2(self):
        self.assertDemandaCumplida("tercera_parte/john_jellicoe/TP3/3_3_2.txt")

    def test_JJ_5_5_6(self):
        self.assertDemandaCumplida("tercera_parte/john_jellicoe/TP3/5_5_6.txt")

    def test_JJ_8_7_10(self):
        self.assertDemandaCumplida("tercera_parte/john_jellicoe/TP3/8_7_10.txt")

    def test_JJ_10_3_3(self):
        self.assertDemandaCumplida("tercera_parte/john_jellicoe/TP3/10_3_3.txt")

    def test_JJ_10_10_10(self):
        self.assertDemandaCumplida("tercera_parte/john_jellicoe/TP3/10_10_10.txt")

    def test_JJ_12_12_21(self):
        self.assertDemandaCumplida("tercera_parte/john_jellicoe/TP3/12_12_21.txt")

    def test_JJ_15_10_15(self):
        self.assertDemandaCumplida("tercera_parte/john_jellicoe/TP3/15_10_15.txt")

    def test_JJ_20_20_20(self):
        self.assertDemandaCumplida("tercera_parte/john_jellicoe/TP3/20_20_20.txt")

    def test_JJ_20_25_30(self):
        self.assertDemandaCumplida("tercera_parte/john_jellicoe/TP3/20_25_30.txt")

    def test_JJ_30_25_25(self):
        self.assertDemandaCumplida("tercera_parte/john_jellicoe/TP3/30_25_25.txt")
