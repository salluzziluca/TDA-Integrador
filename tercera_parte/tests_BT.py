...
class TestBT(unittest.TestCase):
    def test_BT_3_3_2(self):
        ...
        barcos, filas, columnas = procesar_archivo("3_3_2.txt")
    ...
    def test_BT_5_5_6(self):
        barcos, filas, columnas = procesar_archivo("5_5_6.txt")
        demanda_filas = sum(filas)
        demanda_columnas = sum(columnas)
        inicio = time.time()
        result = resolver_tablero(barcos, filas, columnas, demanda_filas, demanda_columnas)
    ...
    def test_BT_8_7_10(self):
        barcos, filas, columnas =  procesar_archivo("8_7_10.txt")
        demanda_filas = sum(filas)
        demanda_columnas = sum(columnas)
        inicio = time.time()
        result = resolver_tablero(barcos, filas, columnas, demanda_filas, demanda_columnas)
    ...
    def test_BT_10_3_3(self):
        barcos, filas, columnas = procesar_archivo("10_3_3.txt")
        demanda_filas = sum(filas)
        demanda_columnas = sum(columnas)
        inicio = time.time()
        result = resolver_tablero(barcos, filas, columnas, demanda_filas, demanda_columnas)
    ...
    def test_BT_10_10_10(self):
        barcos, filas, columnas = procesar_archivo("10_10_10.txt")
        demanda_filas = sum(filas)
        demanda_columnas = sum(columnas)
        demanda_filas = sum(filas)
        demanda_columnas = sum(columnas)
    ...
    def test_BT_15_10_15(self):
        barcos, filas, columnas = procesar_archivo("15_10_15.txt")
        demanda_filas = sum(filas)
        demanda_columnas = sum(columnas)
        inicio = time.time()
        result = resolver_tablero(barcos, filas, columnas, demanda_filas, demanda_columnas)
    ...
    def test_BT_20_20_20(self):
        barcos, filas, columnas = procesar_archivo("20_20_20.txt")
        demanda_filas = sum(filas)
        demanda_columnas = sum(columnas)
        inicio = time.time()
        result = resolver_tablero(barcos, filas, columnas, demanda_filas, demanda_columnas)
    ...
    def test_BT_20_25_30(self):
        barcos, filas, columnas = procesar_archivo("20_25_30.txt")
        demanda_filas = sum(filas)
        demanda_columnas = sum(columnas)
        inicio = time.time()
        result = resolver_tablero(barcos, filas, columnas, demanda_filas, demanda_columnas)
    ...
    def test_BT_30_25_25(self):
        barcos, filas, columnas = procesar_archivo("30_25_25.txt")
        demanda_filas = sum(filas)
        demanda_columnas = sum(columnas)
        inicio = time.time()
        result = resolver_tablero(barcos, filas, columnas, demanda_filas, demanda_columnas)
