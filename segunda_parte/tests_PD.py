...
class TestPD(unittest.TestCase):
    def test_PD_5(self):
        result = programacion_dinamica_sofia(csv_tests_PD("5.txt"))
        self.assertTrue(result == 1483)
    
    def test_PD_10(self):
        result = programacion_dinamica_sofia(csv_tests_PD("10.txt"))
        self.assertTrue(result == 2338)

    def test_PD_20(self):
        result = programacion_dinamica_sofia(csv_tests_PD("20.txt"))
        self.assertTrue(result == 5234)

    def test_PD_25(self):
        result = programacion_dinamica_sofia(csv_tests_PD("25.txt"))
        self.assertTrue(result == 7491)

    def test_PD_50(self):
        result = programacion_dinamica_sofia(csv_tests_PD("50.txt"))
        self.assertTrue(result == 14976)
    
    def test_PD_100(self):
        result = programacion_dinamica_sofia(csv_tests_PD("100.txt"))
        self.assertTrue(result == 28844)

    def test_PD_1000(self):
        result = programacion_dinamica_sofia(csv_tests_PD("1000.txt"))
        self.assertTrue(result == 1401590)
    def test_PD_2000(self):
        result = programacion_dinamica_sofia(csv_tests_PD("2000.txt"))
